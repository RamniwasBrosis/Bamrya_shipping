        ...
        <ul class="metismenu" id="menu">
            ...
            <li><a href="javascript:void(0);" class="has-arrow" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="{{route('airJobCard')}}">Air</a></li>
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="{{ url('admin/forwarders') }}">Forwarder</a></li>
                    ...
                    <li class="">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ url('admin/import-parties') }}">Others Party</a></li>
                            <li><a href="{{ url('admin/export-parties') }}">Shipper Party</a></li>
                            <li><a href="{{ url('admin/purchase-parties') }}">Purchase Party</a></li>
                        </ul>
                    </li>
            ...
            <li>
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="{{ url('admin/sea-exports') }}">Sea Export</a></li>
                    <li><a href="{{ url('admin/upload-files') }}">File Download</a></li>
                    <!--<li><a href="{{ url('admin/sea-import-data-entry') }}">Sea Import Data Entry</a></li>-->
                    ...
                    <li><a href="{{ url('admin/dsr-report') }}">DSR Report</a></li>
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="{{ url('admin/all-sales-person') }}">Total Sales By Persons</a></li>
                    <li class="">
                        <a class="has-arrow" href="javascript:void(0);" aria-expanded="false">
                            <span class="nav-text">Party Verification</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="{{ url('admin/shipper-verification-party') }}">Shipper Party</a></li>
                            <li><a href="{{ url('admin/other-verification-party') }}">Other Party</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
