                ...
                <div class="card-body">
                    <form action="{{ route('export-parties.update', $exportParty->id ) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row form-material">
                            ...
                            <div class="col-xl-3 col-xxl-12 col-md-6 mb-3" id="">
                                <label for="" class="col-sm-4 col-form-label">Party Mode:</label>
                                <div class="col-sm-12">
                                    <select class="form-control" name="party_mode">
                                        <option value="" selected>select</option>
                                        <option value="local" {{$exportParty->party_mode == 'local' ? 'selected' : ''}}>Local</option>
                                        <option value="foreign" {{$exportParty->party_mode == 'foreign' ? 'selected' : ''}}>Foreign</option>
                                    </select>
