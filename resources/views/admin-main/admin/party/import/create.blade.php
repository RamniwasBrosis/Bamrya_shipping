...
<div class="page-titles">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:void(0)">Add New IMPORT Party</a></li>
    </ol>
...
<div class="container-fluid p-2">
    <div class="row">
        <div class="col-xl-12 col-xxl-12">
            <div class="card">
                <div class="card-body">
                    <form id="importPartyForm"  action="{{ route('import-parties.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-xl-3 col-xxl-12 col-md-6 mb-3">
                                ...
                                <select class="default-select  form-control wide" name="party_type">
                                    ...
                                    @foreach ($parties as $party)
                                        <option value="{{$party->party_type}}">{{$party->party_name}}</option>                                        
                                    @endforeach
                                </select>
...
$(document).ready(function() {
    $(document).on('submit', '#importPartyForm', function(e) {
        e.preventDefault();
