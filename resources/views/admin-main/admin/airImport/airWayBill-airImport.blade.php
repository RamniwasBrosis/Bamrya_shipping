...
<body>
  <div class="container" style="font-family: Arial, sans-serif; font-size: 10px; max-width: 880px; margin: 0 auto; background-color: #fff; color: #000; line-height: 1.3;">
    ...
    <div style="display: flex; justify-content: space-between; margin-bottom: 3px; font-weight: bold; font-size: 18px;">
      <span>{{$airImportDraftData->mawb_no}}</span>
      <span>{{$airImportDraftData->hawb_no}}</span>
    </div>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td style=" padding: 4px 6px; font-size: 10px; vertical-align: top; ">
            <div style="font-size: 10px; color: #555; margin-bottom: 2px;">Not Negotiable</div>
            <div style="font-weight: bold; font-size: 12px; margin-top: 3px;">Air Waybill</div>
            <div style="margin-top: 5px; d-flex">
              <span style="font-size: 10px;">Issued by</span>
              <span style="font-weight: bold; margin-left: 40px; font-size: 16px;">{{$airImportDraftData->airLineName ?? ''}}</span>
            </div>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td style="border: 1px solid #000;border-top: none;border-left: none; padding: 4px 6px; font-size: 10px; vertical-align: top;">
            ...
            <div style="font-weight: bold; font-size: 10px;">{{$airImportDraftData->iataAgent->party_name ?? 'N/A'}} &nbsp; {{$airImportDraftData->iataAgent->address_line1 ?? ''}},</div>
            <div>{{$airImportDraftData->iataAgent->city ?? 'N/A'}}&nbsp;-&nbsp;{{$airImportDraftData->iataAgent->pincode ?? 'N/A'}}</div>
            <!--<div>INDIA</div>-->
          </td>
          <td colspan="2" style="border: 1px solid #000;border-top: none;border-left: none; padding: 4px 6px; font-size: 10px; vertical-align: top;">
            <div style="font-size: 10px; color: #555; margin-bottom: 2px;">Accounting Information</div>
            <div style="font-weight: bold; font-size: 10px;">{{$airImportDraftData->accounting_information ?? ''}}</div>
          </td>
        </tr>
        ...
        <tr>
          <td style="border: 1px solid #000;border-top: none;border-left: none; padding: 0; vertical-align: top;">
            <table style="width:100%; height: 100%; border-collapse: collapse;" >
              <tbody>
                <tr >
                  <td style="width: 10%; border-bottom:1px solid #000; padding:2px; text-align:center; width:10%;  text-align: left">
                  ...
                  <td style="border-left:1px solid #000; border-bottom:1px solid #000; width: 50%; padding:4px; font-size:8px; text-align:center; position:relative; vertical-align: top; text-align: left">
                  ...
                  <td style="border-left:1px solid #000; border-bottom:1px solid #000; width: 10%; padding:2px; font-size:10px; color: #555; text-align:center; width:10%;vertical-align: top; text-align: left">to</td>
                  <td style="border-left:1px solid #000; border-bottom:1px solid #000; width: 10%; padding:2px; font-size:10px; color: #555; text-align:center; width:10%;vertical-align: top; text-align: left">by</td>
                  <td style="border-left:1px solid #000; border-bottom:1px solid #000; width: 10%; padding:2px; font-size:10px; color: #555; text-align:center; width:10%;vertical-align: top; text-align: left">to</td>
                  <td style="border-bottom:1px solid #000; width: 10%; padding:2px; font-size:10px; color: #555; text-align:center; width:10%;vertical-align: top; text-align: left;">by</td>
                </tr>
              </tbody>
            </table>
          </td>
        ...
        <tr>
          <td colspan="3" style="border:1px solid #000;border-top: none;border-left: none; padding:4px 6px; font-size:10px; vertical-align: top;">
            <div style="font-size:10px; color:#555; margin-bottom:2px;">Handling Information</div>
            <div>NOTIFY: {{$airImportDraftData->handling_information ?? '-'}}</div>
          </td>
        </tr>
            ...
            <table style="width:100%; border-collapse: collapse; position:relative;">
              <tbody>
                ...
                <tr>
                  ...
                  <td style="border:1px solid #000;border-left: none; padding:4px; text-align:center; font-weight:bold; height:160px; vertical-align: top;">{{$airImportDraftData->gross_weight ?? '-'}}</td>
                  ...
                  <td rowspan="2" style="border:1px solid #000; font-size:9px; letter-spacing: 1px; border-right:0px; border-bottom:0px; padding:4px; text-align:center; font-weight:normal; height:160px; vertical-align: top;">
                ...
                <tr>
                  ...
                  <td style="border:0px; padding:4px; text-align:center; font-weight:bold;">{{ number_format($totalGrossWeight, 2) }}</td>
                  <td style="border:0px; padding:4px; text-align:center; font-weight:bold;">{{ number_format($totalAmount, 2) }}</td>
                </tr>
