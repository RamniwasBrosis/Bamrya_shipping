...
<button id="downloadBtn" class="download-btn" data-html2canvas-ignore="true">Download Sea Job Card</button>
    ...
    <div class="inner-border">
        <div class="header">
            <div class="header-left">
                <div class="row">
                    <span class="label">Sea JOB NO.</span>

                    <div class="line-block">
                        <div class="line-text">{{ $data['sea_job_no'] ?? '' }}</div>
                        <div class="line-date">{{ $data['sea_job_date'] ?? '' }}</div>
                    </div>
                </div>
        ...
        <div class="main-body">
            ...
            <div class="row">
                <div class="field" style="flex: 2;"><span class="label">INVOICE NO.</span><span class="line">{{$data['invoice_no']}}</span></div>
            ...
            <div class="row">
                <div class="field"><span class="label">SHIPPING LINE NAME</span><span class="line">{{$data['shipping_line_name']}}</span></span></div>
                <div class="field"><span class="label">VESSEL / VOY / NAME</span><span class="line">{{$data['vessel_voy_name']}}</span></span></div>
            </div>
            <div class="row">
                <div class="field"><span class="label">Container NO.</span><span class="line">{{$data['container_no']}}</span></div>
                <div class="field"><span class="label">BL NO.</span><span class="line">{{$data['bl_no']}}</span></div>
            </div>
            <div class="row">
                <div class="field" style="flex: 3;"><span class="label">SEAL NO.</span><span class="line">{{$data['seal_no']}}</span></div>
            ...
            <div class="row" style="font-size:12px; align-items:center;">
                ...
                <!-- LCL YES / CHECK -->
                <div class="box-field" style="margin-left:6px;">
                ...
                <!-- LCL VALUE -->
                <span class="line" style="width:90px; margin-left:6px;">
                    {{ $data['lcl_value'] ?? '' }}
                </span>
                ...
                <div class="box-field" style="margin-left:6px;">
                    ...
                    <div class="box" style="font-size: 16px;text-align: center;">
                        {{ ($data['lcl_import_export'] ?? '') == 'lcl_import' ? '✔' : '' }}
                    </div>
                </div>

                <!-- LCL EXPORT -->
                <div class="box-field" style="margin-left:4px;">
                    <span class="label">EXP</span>
                    <div class="box" style="font-size: 16px;text-align: center;">
                        {{ ($data['lcl_import_export'] ?? '') == 'lcl_export' ? '✔' : '' }}
                    </div>
                </div>
            ...
            <div class="row" style="font-size:12px; align-items:center; margin-top:6px;">
                ...
                <div class="box-field" style="margin-left:6px;">
                    <span class="label">IMP</span>
                    <div class="box" style="font-size: 16px;text-align: center;">
                        {{ ($data['fcl_import_export'] ?? '') == 'fcl_import' ? '✔' : '' }}
                    </div>
                </div>
                ...
                <div class="box-field" style="margin-left:4px;">
                    <span class="label">EXP</span>
                    <div class="box" style="font-size: 16px;text-align: center;">
                        {{ ($data['fcl_import_export'] ?? '') == 'fcl_export' ? '✔' : '' }}
                    </div>
                </div>
        ...
        <div class="footer-section">
            ...
            <div class="flight-col" style="border-right: 3px solid black;">
                <div class="flight-details">
                    <div style="font-weight: bold;">SOB Details:</div>
                    <div class="flight-line">{{$data['sob_details']}}</div>
                    <div class="flight-line"></div>
                </div>
                <div class="bottom-boxes">
                    <div class="box-field"><span class="label">M.M/B.L</span><div class="box" style="text-align: center;">{{ isset($data['mmbl']) ? '✔' : '' }}</div></div>
                    <div class="box-field"><span class="label">LEO</span><div class="box" style="text-align: center;">{{ isset($data['leo']) ? '✔' : '' }}</div></div>
                </div>
                <div class="bottom-boxes" style="border-top: none; border-bottom: 3px solid black;">
                    <div class="box-field"><span class="label">PURCHASE BILL</span><div class="box" style="text-align: center;">{{ isset($data['purchase_bill']) ? '✔' : '' }}</div></div>
                    <div class="box-field"><span class="label">SALES BILL</span><div class="box" style="text-align: center;">{{ isset($data['sale_bill']) ? '✔' : '' }}</div></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div style="text-align: center; font-weight: bold; margin-bottom: 10px;margin-top: 20px;">
          ...
          <table style="width: 100%; border-collapse: collapse; border: 1px solid black;">
            <tr>
              ...
              <th style="border: 1px solid black; padding: 5px; text-align: left;">SEA CHARGES PARTICULARS</th>
            ...
            <tr>
              ...
              <td style="border: 1px solid black; padding: 5px;">OCEAN CHARGES</td>
              <td style="border: 1px solid black; padding: 5px;"></td>
            </tr>
            <tr>
              <td style="border: 1px solid black; padding: 5px; text-align: center;">2</td>
              <td style="border: 1px solid black; padding: 5px;">ON CARRIAGE CHARGES</td>
              <td style="border: 1px solid black; padding: 5px;"></td>
            </tr>
            <tr>
              <td style="border: 1px solid black; padding: 5px; text-align: center;">3</td>
              <td style="border: 1px solid black; padding: 5px;">THC CHARGES</td>
              <td style="border: 1px solid black; padding: 5px;"></td>
            </tr>
            <tr>
              <td style="border: 1px solid black; padding: 5px; text-align: center;">4</td>
              <td style="border: 1px solid black; padding: 5px;">STUFFING CHARGES</td>
              <td style="border: 1px solid black; padding: 5px;"></td>
            </tr>
            <tr>
              <td style="border: 1px solid black; padding: 5px; text-align: center;">5</td>
              <td style="border: 1px solid black; padding: 5px;">BL FEE</td>
              <td style="border: 1px solid black; padding: 5px;"></td>
            </tr>
            <tr>
              <td style="border: 1px solid black; padding: 5px; text-align: center;">6</td>
              <td style="border: 1px solid black; padding: 5px;">ENS FEE / ACD / AFR / OTHER</td>
              <td style="border: 1px solid black; padding: 5px;"></td>
            </tr>
            <tr>
              <td style="border: 1px solid black; padding: 5px; text-align: center;">7</td>
              <td style="border: 1px solid black; padding: 5px;">CUSTOM CLEARANCE</td>
              <td style="border: 1px solid black; padding: 5px;"></td>
            </tr>
            <tr>
              <td style="border: 1px solid black; padding: 5px; text-align: center;">8</td>
              <td style="border: 1px solid black; padding: 5px;">AGENCY FEE</td>
              <td style="border: 1px solid black; padding: 5px;"></td>
            </tr>
            <tr>
              <td style="border: 1px solid black; padding: 5px; text-align: center;">9</td>
              <td style="border: 1px solid black; padding: 5px;">SEAL FEE</td>
              <td style="border: 1px solid black; padding: 5px;"></td>
            </tr>
            <tr>
              <td style="border: 1px solid black; padding: 5px; text-align: center;">10</td>
              <td style="border: 1px solid black; padding: 5px;">TOLL CHARGES</td>
              <td style="border: 1px solid black; padding: 5px;"></td>
            </tr>
            <tr>
              <td style="border: 1px solid black; padding: 5px; text-align: center;">11</td>
              <td style="border: 1px solid black; padding: 5px;">MUC</td>
              <td style="border: 1px solid black; padding: 5px;"></td>
            </tr>
            <tr>
              <td style="border: 1px solid black; padding: 5px; text-align: center;">12</td>
              <td style="border: 1px solid black; padding: 5px;">WARAI CHARGES</td>
              <td style="border: 1px solid black; padding: 5px;"></td>
            </tr>
            <tr>
              <td style="border: 1px solid black; padding: 5px; text-align: center;">13</td>
              <td style="border: 1px solid black; padding: 5px;">LOADING / UNLOADING</td>
              <td style="border: 1px solid black; padding: 5px;"></td>
            </tr>
            <tr>
              <td style="border: 1px solid black; padding: 5px; text-align: center;">14</td>
              <td style="border: 1px solid black; padding: 5px;">EXAMINATION EXP.</td>
              <td style="border: 1px solid black; padding: 5px;"></td>
            </tr>
            <tr>
              <td style="border: 1px solid black; padding: 5px; text-align: center;">15</td>
              <td style="border: 1px solid black; padding: 5px;">FUMIGATION</td>
              <td style="border: 1px solid black; padding: 5px;"></td>
            </tr>
            <tr>
              <td style="border: 1px solid black; padding: 5px; text-align: center;">16</td>
              <td style="border: 1px solid black; padding: 5px;">FOLKLIFT / LABOUR</td>
              <td style="border: 1px solid black; padding: 5px;"></td>
            </tr>
            <tr>
              <td style="border: 1px solid black; padding: 5px; text-align: center;">17</td>
              <td style="border: 1px solid black; padding: 5px;">FIRST TIME EXPORT REGISTRATION CHARGES</td>
              <td style="border: 1px solid black; padding: 5px;"></td>
            </tr>
            <tr>
              <td style="border: 1px solid black; padding: 5px; text-align: center;">17</td>
              <td style="border: 1px solid black; padding: 5px;">MISC EXP.</td>
              <td style="border: 1px solid black; padding: 5px;"></td>
            </tr>
          </table>
