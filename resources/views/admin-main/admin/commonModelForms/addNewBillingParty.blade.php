...
<div class="modal fade" id="billingPartyDetailsModal" tabindex="-1" aria-labelledby="oceanVslModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="oceanVslModalLabel">Add New Billing Party</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="billingPartyAdd" method="post" action="{{route('new-party.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3 row">
