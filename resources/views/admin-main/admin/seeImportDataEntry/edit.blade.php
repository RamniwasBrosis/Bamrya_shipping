...
@section('content')
    <div class="page-titles">
        <ol class="breadcrumb">
            <li class="breadcrumb-item active"><a href="#">Edit Sea Import Data Entry BL</a></li>
        </ol>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('sea-import-data-entry.update', $sea_import->id) }}" method="POST" class="needs-validation" novalidate>
                            @csrf
                            @method('PUT')
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="package_type" class="default-select form-control wide me-2">
                                                    <option value="">select</option>
                                                    <option value="CARTON" {{$sea_import->package_type == 'CARTON' ? 'selected' : ''}}>CARTON</option>
                                                    <option value="PALLET" {{$sea_import->package_type == 'PALLET' ? 'selected' : ''}}>PALLET</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9 d-flex align-items-center">
                                                <select name="port_loading_id" class="default-select form-control wide me-2">
                                                    ...
                                                    @foreach ($ports as $port)
                                                        <option value="{{$port->id}}" {{$sea_import->port_loading_id == $port->id ? 'selected' : ''}}>{{$port->port_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9 d-flex align-items-center">
                                                <select name="port_discharge_id" class="default-select form-control wide me-2">
                                                    <option value="">select</option>
                                                    @foreach ($ports as $port)
                                                        <option value="{{$port->id}}" {{$sea_import->port_discharge_id == $port->id ? 'selected' : ''}}>{{$port->port_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9 d-flex align-items-center">
                                                <select name="port_destination_id" class="default-select form-control wide me-2">
                                                    <option value="">select</option>
                                                    @foreach ($ports as $port)
                                                        <option value="{{$port->id}}" {{$sea_import->port_destination_id == $port->id ? 'selected' : ''}}>{{$port->port_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9 d-flex align-items-center">
                                                <select name="port_delivery_id" class="default-select form-control wide me-2">
                                                    <option value="">select</option>
                                                    @foreach ($ports as $port)
                                                        <option value="{{$port->id}}" {{$sea_import->port_delivery_id == $port->id ? 'selected' : ''}}>{{$port->port_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                        ...
                        <div class="form-validation">
                            <form class="needs-validation" method="POST" action="{{route('sea-import-data-entry.updateContainer', $sea_import->container->id)}}">
                                @csrf
                                @method('PUT')
                                <div class="row">                                   
                                    <div class="col-xl-6">
                                        ...
                                        <div class="mb-3 row row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="default-select form-control wide me-2" name="cargo_type" placeholder="Select">
                                                    <option value="">select</option>
                                                    <option value="GEN" {{$sea_import->container->cargo_type == 'GEN'? 'selected' : ''}}>GEN</option>
                                                    <option value="HAZ" {{$sea_import->container->cargo_type == 'HAZ'? 'selected' : ''}}>HAZ</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3 row row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="default-select form-control wide me-2" name="size" placeholder="Select">
                                                    <option value="">Select</option>
                                                    <option value="1" {{$sea_import->container->size == '1'? 'selected' : ''}}>0</option>
                                                    <option value="20 GP" {{$sea_import->container->size == '20 GP'? 'selected' : ''}}>20 GP</option>
                                                    <option value="40 GP" {{$sea_import->container->size == '40 GP'? 'selected' : ''}}>40 GP</option>
                                                    <option value="40 HQ" {{$sea_import->container->size == '40 HQ'? 'selected' : ''}}>40 HQ</option>
                                                    <option value="20 OT" {{$sea_import->container->size == '20 OT'? 'selected' : ''}}>20 OT</option>
                                                    <option value="40 OT" {{$sea_import->container->size == '40 OT'? 'selected' : ''}}>40 OT</option>
                                                    <option value="20 FR" {{$sea_import->container->size == '20 FR'? 'selected' : ''}}>20 FR</option>
                                                    <option value="40 FR" {{$sea_import->container->size == '40 FR'? 'selected' : ''}}>40 FR</option>
                                                    <option value="20 TK" {{$sea_import->container->size == '20 TK'? 'selected' : ''}}>20 TK</option>
                                                    <option value="40 TK" {{$sea_import->container->size == '40 TK'? 'selected' : ''}}>40 TK</option>
                                                    <option value="20 RF" {{$sea_import->container->size == '20 RF'? 'selected' : ''}}>20 RF</option>
                                                    <option value="40 RF" {{$sea_import->container->size == '40 RF'? 'selected' : ''}}>40 RF</option>
                                                    <option value="20 ODO" {{$sea_import->container->size == '20 ODO'? 'selected' : ''}}>20 ODO</option>
                                                    <option value="40 ODO" {{$sea_import->container->size == '40 ODO'? 'selected' : ''}}>40 ODO</option>
                                                    <option value="40" {{$sea_import->container->size == '40'? 'selected' : ''}}>40</option>
                                                    <option value="45" {{$sea_import->container->size == '45'? 'selected' : ''}}>45</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3 row row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="default-select form-control wide me-2" name="refer" placeholder="Select">
                                                    <option value="">select</option>
                                                    <option value="Y" {{$sea_import->container->refer == 'Y'? 'selected' : ''}}>Y</option>
                                                    <option value="N" {{$sea_import->container->refer == 'N'? 'selected' : ''}}>N</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3 row row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="default-select form-control wide me-2" name="fcl_lcl" placeholder="Select">
                                                    <option value=""></option>
                                                    <option value="FCL" {{$sea_import->container->fcl_lcl == 'FCL'? 'selected' : ''}}>FCL</option>
                                                    <option value="LCL" {{$sea_import->container->fcl_lcl == 'LCL'? 'selected' : ''}}>LCL</option>
                                                    <option value="ETY" {{$sea_import->container->fcl_lcl == 'ETY'? 'selected' : ''}}>ETY</option>
                                                    <option value="AIR" {{$sea_import->container->fcl_lcl == 'AIR'? 'selected' : ''}}>AIR</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
