...
<body>
    ...
    @php
        ...
        // Format dates
        $sobDate = $seaExportDraftData->sob_date ? date('d M Y', strtotime($seaExportDraftData->sob_date)) : '';
        $formattedIssueDate = $issueDate;
        if (strtotime($issueDate)) {
            $formattedIssueDate = date('d/m/Y', strtotime($issueDate));
        }
        
        // Get package details from seaExportDraftData if no containers
        $totalPackages = 0;
        $goodsDescription = '';
        $grossWeight = 0;
        $netWeight = 0;
        ...
        if (!$hasContainers) {
            $totalPackages = safeData($seaExportDraftData, 'total_package', 0);
            $goodsDescription = safeData($seaExportDraftData, 'goods_description', '');
            $grossWeight = safeData($seaExportDraftData, 'gross_weight', 0);
            $netWeight = safeData($seaExportDraftData, 'net_weight', 0);
            $cbm = safeData($seaExportDraftData, 'cbm', 0);
        }
    @endphp
                    ...
                    <div class="border-box">
                            ...
                            <div class="col" style="width: 55%; padding: 0; display: flex; flex-direction: column;">
                                <div class="row" style="height: 20px;">
                                    ...
                                    <div class="col" style="width: 50%; border-bottom: none; font-weight: bold; text-align: center;">
                                        {{ safeData($seaExportDraftData, 'booking_no') }}
                                    </div>
                                </div>
                                <div class="row" style="height: 20px;">
                                    ...
                                    <div class="col" style="width: 50%; font-weight: bold; text-align: center;">
                                        {{ $seaExportDraftData->mbl_no ?? $seaExportDraftData->hbl_no ?? 'N/A' }}
                                    </div>
                                </div>
                        ...
                        <div class="row" style="height: 45px;">
                            <div class="col" style="width: 22.5%;">
                                <span class="label">Place Of Acceptance</span>
                                <div class="content-text">{{ safeData($seaExportDraftData, 'place_of_acceptance', 'N/A') }}</div>
                            </div>
                            <div class="col" style="width: 22.5%;">
                                <span class="label">Port Of Loading</span>
                                <div class="content-text">{{ safeData($seaExportDraftData->loadingPortName, 'port_name', 'N/A') }}</div>
                            </div>
                        ...
                        <div class="row" style="height: 45px;">
                            <div class="col" style="width: 22.5%;">
                                ...
                                <div class="content-text">{{ safeData($seaExportDraftData->dischargePortName, 'port_name', 'N/A') }}</div>
                            </div>
                            <div class="col" style="width: 22.5%;">
                                <span class="label">Place Of Delivery</span>
                                <div class="content-text">{{ safeData($seaExportDraftData->deliveryPortName, 'port_name', 'N/A') }}</div>
                            </div>
                            <div class="col" style="width: 55%; padding: 0;"></div>
                        </div>
                        ...
                        <div class="row" style="height: 45px;">
                            <div class="col" style="width: 45%;">
                                ...
                                <div class="content-text">
                                    {{ safeData($seaExportDraftData, 'vessel_name', 'N/A') }} V. {{ safeData($seaExportDraftData, 'voyage_no', 'N/A') }}
                                </div>
                            </div>
                            ...
                            <div class="col" style="width: 30%;">
                                ...
                                <div class="content-text">{{ safeData($seaExportDraftData, 'transhipment_port', 'N/A') }}</div>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    <tr style="height: 300px; vertical-align: top;">
                                        <td>
                                            ...
                                            <b>A.S.No:</b> {{ safeData($container, 'agent_seal_no', 'N/A') }}<br>
                                            <!--<b>PACKAGES:</b> {{ safeData($container, 'total_package') }} {{ safeData($seaExportDraftData->packageName, 'package_code') }}<br>-->
                                            @if(!empty($container->mark_number))
                                                <b>Marks and Numbers:</b><br>
                                                {{ $container->mark_number }}<br><br>
                                            @endif
                                            
                                            {{ safeData($container, 'fcl_lcl', 'N/A') }}/{{ safeData($container, 'fcl_lcl', 'N/A') }}, {{ safeData($seaExportDraftData, 'movement', '') }}<br>
                                            ...
                                            <div style="font-size: 10;">
                                                ...
                                                @foreach($containers as $index => $cont)
                                                    @if($index >= 1) {{-- 2nd container se start --}}
                                                        Cont. No.{{ $cont['container_no'] }}/{{ $cont['size'] }}
                                        ...
                                        <td>    
                                            @php
                                                $qty = safeData($container, 'total_package');
                                                $formatter = new \NumberFormatter('en', \NumberFormatter::SPELLOUT);
                                                $qtyInWords = ucfirst($formatter->format($qty));
                                            @endphp
                                            
                                            <b>Total Packages:</b> 
                                            {{ $qty }} {{ safeData($seaExportDraftData->packageName, 'package_code') }} ONLY
                                            ({{ $qtyInWords }} Packages)
                                            <br>
                        ...
                        <div class="row" style="border-top: 1px solid #000; text-align: center; height: 25px;">
                            <div style="width: 100%; text-align: center; padding: 5px;">
                                <b>FREIGHT : </b>{{ strtoupper(safeData($seaExportDraftData, 'freight', 'PREPAID')) }}
                            </div>
                        </div>
                        ...
                        <div class="row" style="height: 137px;">
                            <div class="col" style="width: 40%; display: flex; flex-direction: column; justify-content: space-between;">
                                <div>
                                    @if(safeData($seaExportDraftData->agentName, 'party_name'))
                                        <span class="label">Booking Party: {{ safeData($seaExportDraftData->agentName, 'party_name') }}</span><br>
                                    @endif
                                ...
                                <div class="row" style="flex-grow: 1; height: 70%; border-bottom: none;">
                                    ...
                                    <div class="col" style="width: 50%;">
                                        ...
                                        <div style="text-align: center; font-weight: bold; margin-top: 5px; font-size: 12px;">
                                            {{ safeData($seaExportDraftData, 'issue_place', '') }} &nbsp;&nbsp;&nbsp; {{ $formattedIssueDate }}
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="page">
                ...
                <div class="border-box" style="border: none;" style="padding: 10px;">
                    <div style="text-align: center; margin-bottom: 15px; font-size: 12px;">
                        <strong>Booking No:</strong> {{ safeData($seaExportDraftData, 'booking_no') }} | 
                        <strong>BL No:</strong> {{ $seaExportDraftData->mbl_no ?? $seaExportDraftData->hbl_no ?? 'N/A' }} |
                    ...
                    <table style="width: 100%; border-collapse: collapse; font-size: 8.5px; margin-bottom: 20px;">
                        ...
                        <tbody>
                            @php
                                $additionalContainers = $seaExportDraftData->container->slice(1);
                                $counter = 2;
                            @endphp
                            ...
                            <tr style="height: 75px;">
                                ...
                                <td style="padding: 4px; vertical-align: top;">
                                    <strong>Packages:</strong> {{ safeData($cont, 'total_package') }} {{ safeData($seaExportDraftData->packageName, 'package_code') }}<br>
                    ...
                    <table class="goods-table">
                        ...
                        <tbody>
                            <tr style="height: 300px; vertical-align: top;">
                                <td>
                                    <b>NO CONTAINER</b><br>
                                    <b>PACKAGES:</b> {{ $totalPackages }} {{ safeData($seaExportDraftData->packageName, 'package_code') }}<br>
                                    @if(safeData($seaExportDraftData, 'mark_number'))
                                        <b>Marks and Numbers:</b><br>
                                        {{ safeData($seaExportDraftData, 'mark_number') }}<br><br>
                                    @endif
                                    
                                    @if(safeData($seaExportDraftData, 'fcl_lcl'))
                                        {{ safeData($seaExportDraftData, 'fcl_lcl', '') }}/{{ safeData($seaExportDraftData, 'fcl_lcl', '') }}, {{ safeData($seaExportDraftData, 'movement', 'N/A') }}
                                    @endif
                                    <br>
                                    ALL DESTINATION CHARGES ON CONSIGNEE ACCOUNT
                                    <br><br><br><br><br><br>
                                ...
                                <td>
                                    <b>Total Packages:</b> {{ $totalPackages }} {{ safeData($seaExportDraftData->packageName, 'package_code') }} ONLY<br>
                                    <b>Goods Description:</b><br>
                                    {{ $goodsDescription }}<br>
                                    
                                    @if(safeData($seaExportDraftData, 'customer_inv_no'))
                                        <br><b>INVOICE NO:</b> {{ safeData($seaExportDraftData, 'customer_inv_no') }}
                                    @endif
                                    @if(safeData($seaExportDraftData, 'sbill_no'))
                                        <b>SB. NO:</b> {{ safeData($seaExportDraftData, 'sbill_no') }}<br>
                                    @endif
                                    <br><br><br><br><br>
                                    <div style="text-align: right; margin-top: 20px; font-weight: bold;">
    ...
    <script>
        async function downloadPDF() {
            ...
            try {
                ...
                const opt = {
                    margin: 0,
                    filename: 'Sea_Way_Bill_{{ $seaExportDraftData->booking_no ?? "document" }}.pdf',
                    image: {
                        type: 'jpeg',
                        quality: 3
                    },
                ...
                await $.ajax({
                    url: "{{ route('sea.export.check.download') }}",
                    method: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
                        job_no: "{{ $seaExportDraftData->job_no }}",
                        copy_type: "{{ $blType }}"
                    }
                });
                ...
                // Record download
                await $.ajax({
                    url: "{{ route('sea.export.confirm.download') }}",
                    method: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
                        job_no: "{{ $seaExportDraftData->job_no }}",
