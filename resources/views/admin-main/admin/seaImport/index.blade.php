                            ...
                            <tbody>
                                @foreach ($sea_imports as $sea_import)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$fy}}</td>
                                        <td>
                                            <a class="badge badge-info light border-0" href="{{url('admin/sea-imports/'.$sea_import->uuid.'/edit')}}">Edit</a>
                                            <a class="badge badge-danger light border-0 delete-sea-import" href="javascript:void(0);" data-id="{{$sea_import->id}}">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
