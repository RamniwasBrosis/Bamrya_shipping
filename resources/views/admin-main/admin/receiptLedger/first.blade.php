...
@section('content')
    <div class="page-titles">
        <ol class="breadcrumb">
            <li>
                <h5 class="bc-title">Sales Ledger Report</h5>
            </li>
        </ol>
        <!--<a class="text-primary fs-13" href="{{ url('admin/ReceiptLedger/index') }}">Go List -></a>-->
    </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="reportPreview" class="mt-5 border border-dark p-4 overflow-x-auto" style="display: none;">
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            function fetchPage(page = 1) {
                ...
                $.ajax({
                    url: '{{ route("receipt-ledger.preview") }}?page=' + page,
                    type: 'POST',
                    data: data,
