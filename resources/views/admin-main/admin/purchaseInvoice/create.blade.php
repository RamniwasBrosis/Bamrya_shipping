            ...
            <div class="col-xl-12 col-xxl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="smartwizard" class="form-wizard order-create">
                            <div class="row form-material">
                                ...
                                <div class="form-validation">
                                    <form method="POST" action="{{route('purchase-invoices.store')}}" class="needs-validation">
                                        @csrf
                        ...
                        <hr>
                        <div class="form-validation">
                            <form class="needs-validation" method="POST" action="{{ route('purchase-invoices.purchaseInvoiceCharge') }}">
                                @csrf
                                <input type="hidden" name="purchaseInvoice_id" value="{{session('id')}}">
                                <div class="row">
                                    <!-- Charge Name -->
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="tds_amount" class="form-control">
                                            </div>
                                        </div>
                                    </div>
