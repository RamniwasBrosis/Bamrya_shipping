...
<body>
  <div class="container" style="font-family: Arial, sans-serif; font-size: 10px; max-width: 100%; margin: 0 auto; background-color: #fff; color: #000; line-height: 1.3;">
    ...
    <div style="display: flex; justify-content: space-between; margin-bottom: 3px; font-weight: bold; font-size: 18px;">
      <span>{{$airExportDraftData->mawb_no}}</span>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td style="border: 1px solid #000; padding: 4px 6px; font-size: 10px; vertical-align: top; width: 50%;">
            ...
            <div style="margin-top: 5px;">
              ...
              <span style="font-weight: bold; margin-left: 40px; font-size: 16px;">{{$airExportDraftData->flight_name_1 ?? ''}}</span>
            </div>
          </td>
        </tr>
        ...
        <tr>
          <td style="border: 1px solid #000; border-right:none; border-top:none; padding: 4px 6px; font-size: 10px; vertical-align: top;">
            ...
            <div style="font-weight: bold; font-size: 10px;">{{$airExportDraftData->LataAgentName->party_name ?? 'N/A'}} &nbsp; {{$airExportDraftData->LataAgentName->address_line1 ?? ''}},</div>
            <div>{{$airExportDraftData->LataAgentName->city ?? 'N/A'}}&nbsp;-&nbsp;{{$airExportDraftData->LataAgentName->pincode ?? 'N/A'}}</div>
            <!--<div>INDIA</div>-->
          </td>
          <td colspan="2" style="border: 1px solid #000; border-top:none; padding: 4px 6px; font-size: 10px; vertical-align: top;">
            <div style="color: #555; margin-bottom: 2px;">Accounting Information</div>
            <div style="font-weight: bold; font-size: 10px;">{{$airExportDraftData->accountingInformation ?? ''}}</div>
          </td>
        </tr>
        ...
        <tr>
          <td style="border: 1px solid #000; border-right:none; border-top:none; padding: 0; vertical-align: top;">
            <table style="width:100%; height: 100%; border-collapse: collapse;" >
              <tbody>
                <tr >
                  <td style="border-bottom:1px solid #000; width: 10%; padding:2px; font-size:8px; text-align:center; width:10%;  text-align: left">
                  ...
                  <td style="border-left:1px solid #000; border-bottom: 1px solid #000; width: 50%; padding:0px; font-size:8px; text-align:center; position:relative;vertical-align: top; text-align: left">
                    ...
                    <div style="font-size: 12px;">{{$airExportDraftData->by_first_carrier ?? ''}}</div>
                  </td>
                  <td style="border-left:1px solid #000;border-bottom:1px solid #000; width: 10%; padding:2px; font-size:8px; text-align:center; width:10%;vertical-align: top; text-align: left">to</td>
                  <td style="border-left:1px solid #000;border-bottom:1px solid #000; width: 10%; padding:2px; font-size:8px; text-align:center; width:10%;vertical-align: top; text-align: left">by</td>
                  <td style="border-left:1px solid #000;border-bottom:1px solid #000; width: 10%; padding:2px; font-size:8px; text-align:center; width:10%;vertical-align: top; text-align: left">to</td>
                  <td style="border-left:1px solid #000;border-bottom:1px solid #000; width: 10%; padding:2px; font-size:8px; text-align:center; width:10%;vertical-align: top; text-align: left;">by</td>
                </tr>
              </tbody>
              ...
              <tbody>
                <tr>
                  ...
                  <td style="width:50%; border-left:1px solid #000; padding-left:10px; vertical-align: top;">
                    ...
                    <div style=" padding: 0; display: flex;">
                      <div style="width: 50%; text-align: center; border-right:1px solid #000;">{{$airExportDraftData->flight_number_1 ?? ''}}</div>
                      <div style="width: 50%; text-align: center;">{{$airExportDraftData->flight_date_1 ?? ''}}</div>
                    </div>
                  </td>
                </tr>
              </tbody>
        ...
        <tr>
          <td colspan="3" style="border:1px solid #000; border-top: none; padding:4px 6px; font-size:9px; vertical-align: top;">
            <div style="color:#555; margin-bottom:2px;">Handling Information</div>
            <div>{{$airExportDraftData->handling_information ?? '-'}}</div>
          </td>
        </tr>
          ...
          <td colspan="3" style="border:1px solid #000; border-top:none; padding:0; vertical-align: top;">
            <table style="width:100%; border-collapse: collapse; position:relative;">
              <tbody>
                ...
                @endphp
                <tr>
                  <td style="border:1px solid #000; border-right:none; border-left:0px; padding:8px; text-align:center; font-weight:bold; height:220px; vertical-align: top;">{{$airExportDraftData->package ?? '0'}}</td>
                  <td style="border:1px solid #000; border-right:none; padding:8px; text-align:center; font-weight:bold; height:220px; vertical-align: top;">{{$airExportDraftData->gross_weight ?? '-'}}</td>
                  <td rowspan="2" style="border:1px solid #000; border-right:none; border-bottom:0px; padding:8px; text-align:center; height:220px; vertical-align: top;">K</td>
                  <td rowspan="2" style="border:1px solid #000; border-right:none; border-bottom:0px; padding:8px; text-align:center; height:220px; vertical-align: top;"></td>
                  <td rowspan="2" style="border:1px solid #000; border-right:none; border-bottom:0px; padding:8px; text-align:center; height:220px; vertical-align: top;">Q</td>
                  <td rowspan="2" style="border:1px solid #000; border-right:none; border-bottom:0px; padding:8px; text-align:center; height:220px; vertical-align: top;"></td>
                  <td rowspan="2" style="border:1px solid #000; border-right:none; border-bottom:0px; padding:8px; text-align:center; font-weight:bold; height:220px; vertical-align: top;"></td>
                  <td rowspan="2" style="border:1px solid #000; border-right:none; border-bottom:0px; padding:8px; text-align:center; font-weight:bold; height:220px; vertical-align: top;">{{$airExportDraftData->chargable_weight ?? '-'}}</td>
                  <td rowspan="2" style="border:1px solid #000; border-right:none; border-bottom:0px; padding:8px; text-align:center; font-weight:bold; height:220px; vertical-align: top;"></td>
                  <td rowspan="2" style="border:1px solid #000; border-right:none; border-bottom:0px; padding:8px; text-align:center; font-weight:bold; height:220px; vertical-align: top;">{{$airExportDraftData->rate_charges ?? '-'}}</td>
                  <td rowspan="2" style="border:1px solid #000; border-right:none; border-bottom:0px; padding:8px; text-align:center; font-weight:bold; height:220px; vertical-align: top;"></td>
                  <td style="border:1px solid #000; border-right:none; padding:8px; text-align:center; font-weight:bold; height:220px; vertical-align: top;">{{ $totalChargableWeight }}</td>
                  <td rowspan="2" style="border:1px solid #000; border-right:none; border-bottom:0px; border-right:0px; padding:8px; text-align:center; font-weight:bold; height:220px; vertical-align: top;"></td>
                  <td rowspan="2" style="border:1px solid #000; border-right:none; font-size:9px; letter-spacing: 1px; border-right:0px; border-bottom:0px; padding:4px; text-align:center; font-weight:normal; height:220px; vertical-align: top;">
                ...
                <tr>
                  ...
                  <td style="border:0px; padding:8px; text-align:center; font-weight:bold;">{{ number_format($totalAmount, 2) }}</td>
                </tr>
