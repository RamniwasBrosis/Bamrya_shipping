            ...
            <div class="col-xl-12 col-xxl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                                    ...
                                    <form method="POST" action="{{route('proforma-invoices.update', $proforma_invoice->id)}}" class="needs-validation">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="text" value="{{$proforma_invoice->job_no}}" class="form-control" name="job_no" style="background: #eee; cursor: not-allowed;">
                                            </div>
                                            <div class="col-md-4 mb-3">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <select name="invoice_type" class="form-control">
                                                    <option value="">Select</option>
                                                    <option value="1" {{$proforma_invoice->invoice_type == '1'? 'selected' : ''}}>DEBITNOTE(Rs)</option>
                                                    <option value="2" {{$proforma_invoice->invoice_type == '2'? 'selected' : ''}}>CREDITNOTE(Rs)</option>
                                                    <option value="3" {{$proforma_invoice->invoice_type == '3'? 'selected' : ''}}>DEBITNOTE(Ovr.)</option>
                                                    <option value="4" {{$proforma_invoice->invoice_type == '4'? 'selected' : ''}}>CREDITNOTE(Ovr.)</option>
                                                    <option value="5" {{$proforma_invoice->invoice_type == '5'? 'selected' : ''}}>COMMISSION/REBATE</option>
                                                    <option value="6" {{$proforma_invoice->invoice_type == '6'? 'selected' : ''}}>SEZ</option>
                                                    <option value="7" {{$proforma_invoice->invoice_type == '7'? 'selected' : ''}}>FRT(IGST)</option>
                                                    <option value="8" {{$proforma_invoice->invoice_type == '8'? 'selected' : ''}}>FRT(CreditNote)</option>
                                                </select>
                                            </div>                                      
                        ...
                        <hr>
                        <div class="form-validation">
                            <form class="needs-validation" method="POST" action="{{ route('proforma-invoices.UpdateProformaInvoiceCharge', $proforma_invoice->id) }}">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <!-- Charge Name -->
                                            ...
                                            <div class="col-sm-9 d-flex align-items-center gap-2">
                                                <select name="charge_name" class="default-select form-control wide me-2">
                                                    ...
                                                    @foreach ($charges as $charge)
                                                        <option value="{{$charge->id}}" {{$proforma_invoice->charge_name == $charge->id? 'selected' : ''}}>{{$charge->charge_name}}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="currency" class="default-select form-control wide me-2">
                                                    <option value="">select</option>
                                                    <option value="AED" {{$proforma_invoice->currency == 'AED'? 'selected' : ''}}>AED</option>
                                                    <option value="AUD" {{$proforma_invoice->currency == 'AUD'? 'selected' : ''}}>AUD</option>
                                                    <option value="BGN" {{$proforma_invoice->currency == 'BGN'? 'selected' : ''}}>BGN</option>
                                                    <option value="BRL" {{$proforma_invoice->currency == 'BRL'? 'selected' : ''}}>BRL</option>
                                                    <option value="CAD" {{$proforma_invoice->currency == 'CAD'? 'selected' : ''}}>CAD</option>
                                                    <option value="CHF" {{$proforma_invoice->currency == 'CHF'? 'selected' : ''}}>CHF</option>
                                                    <option value="CNY" {{$proforma_invoice->currency == 'CNY'? 'selected' : ''}}>CNY</option>
                                                    <option value="CSD" {{$proforma_invoice->currency == 'CSD'? 'selected' : ''}}>CSD</option>
                                                    <option value="CZK" {{$proforma_invoice->currency == 'CZK'? 'selected' : ''}}>CZK</option>
                                                    <option value="DKK" {{$proforma_invoice->currency == 'DKK'? 'selected' : ''}}>DKK</option>
                                                    <option value="EEK" {{$proforma_invoice->currency == 'EEK'? 'selected' : ''}}>EEK</option>
                                                    <option value="EGP" {{$proforma_invoice->currency == 'EGP'? 'selected' : ''}}>EGP</option>
                                                    <option value="EUR" {{$proforma_invoice->currency == 'EUR'? 'selected' : ''}}>EUR</option>
                                                    <option value="GBP" {{$proforma_invoice->currency == 'GBP'? 'selected' : ''}}>GBP</option>
                                                    <option value="HKD" {{$proforma_invoice->currency == 'HKD'? 'selected' : ''}}>HKD</option>
                                                    <option value="HRK" {{$proforma_invoice->currency == 'HRK'? 'selected' : ''}}>HRK</option>
                                                    <option value="HUF" {{$proforma_invoice->currency == 'HUF'? 'selected' : ''}}>HUF</option>
                                                    <option value="IDR" {{$proforma_invoice->currency == 'IDR'? 'selected' : ''}}>IDR</option>
                                                    <option value="ILS" {{$proforma_invoice->currency == 'ILS'? 'selected' : ''}}>ILS</option>

                                                    <option value="INR" {{$proforma_invoice->currency == 'INR'? 'selected' : ''}}>INR</option>
                                                    <option value="ISK" {{$proforma_invoice->currency == 'ISK'? 'selected' : ''}}>ISK</option>
                                                    <option value="JPY" {{$proforma_invoice->currency == 'JPY'? 'selected' : ''}}>JPY</option>
                                                    <option value="MXP" {{$proforma_invoice->currency == 'MXP'? 'selected' : ''}}>MXP</option>
                                                    <option value="MYR" {{$proforma_invoice->currency == 'MYR'? 'selected' : ''}}>MYR</option>
                                                    <option value="NOK" {{$proforma_invoice->currency == 'NOK'? 'selected' : ''}}>NOK</option>
                                                    <option value="NZD" {{$proforma_invoice->currency == 'NZD'? 'selected' : ''}}>NZD</option>
                                                    <option value="PHP" {{$proforma_invoice->currency == 'PHP'? 'selected' : ''}}>PHP</option>
                                                    <option value="PLN" {{$proforma_invoice->currency == 'PLN'? 'selected' : ''}}>PLN</option>
                                                    <option value="ROL" {{$proforma_invoice->currency == 'ROL'? 'selected' : ''}}>ROL</option>
                                                    <option value="RUR" {{$proforma_invoice->currency == 'RUR'? 'selected' : ''}}>RUR</option>
                                                    <option value="SAR" {{$proforma_invoice->currency == 'SAR'? 'selected' : ''}}>SAR</option>
                                                    <option value="SEK" {{$proforma_invoice->currency == 'SEK'? 'selected' : ''}}>SEK</option>
                                                    <option value="SGD" {{$proforma_invoice->currency == 'SGD'? 'selected' : ''}}>SGD</option>
                                                    <option value="SIT" {{$proforma_invoice->currency == 'SIT'? 'selected' : ''}}>SIT</option>

                                                    <option value="SKK" {{$proforma_invoice->currency == 'SKK'? 'selected' : ''}}>SKK</option>
                                                    <option value="THB" {{$proforma_invoice->currency == 'THB'? 'selected' : ''}}>THB</option>
                                                    <option value="TRL" {{$proforma_invoice->currency == 'TRL'? 'selected' : ''}}>TRL</option>
                                                    <option value="TWD" {{$proforma_invoice->currency == 'TWD'? 'selected' : ''}}>TWD</option>
                                                    <option value="UAH" {{$proforma_invoice->currency == 'UAH'? 'selected' : ''}}>UAH</option>
                                                    <option value="US" {{$proforma_invoice->currency == 'US'? 'selected' : ''}}>US</option>
                                                    <option value="USD" {{$proforma_invoice->currency == 'USD'? 'selected' : ''}}>USD</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="rate_basis" class="default-select form-control wide me-2">
                                                    <option value="">select</option>
                                                    <option value="LUMPSUM" {{$proforma_invoice->rate_basis == 'LUMPSUM'? 'selected' : ''}}>LUMPSUM</option>
                                                    <option value="CBMWISE" {{$proforma_invoice->rate_basis == 'CBMWISE'? 'selected' : ''}}>CBMWISE</option>
                                                    <option value="PERCONT" {{$proforma_invoice->rate_basis == 'PERCONT'? 'selected' : ''}}>PERCONT</option>
                                                    <option value="GWTWISE" {{$proforma_invoice->rate_basis == 'GWTWISE'? 'selected' : ''}}>GWTWISE</option>
                                                    <option value="CHGWTWISE" {{$proforma_invoice->rate_basis == 'CHGWTWISE'? 'selected' : ''}}>CHGWTWISE</option>
                                                    <option value="PERUNIT" {{$proforma_invoice->rate_basis == 'PERUNIT'? 'selected' : ''}}>PERUNIT</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="per_unit" class="form-control" value="{{$proforma_invoice->per_unit}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="exchange_rate" class="form-control" value="{{$proforma_invoice->exchange_rate}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="freight" class="form-control" value="{{$proforma_invoice->freight}}">
                                            </div>
                                        </div>
                                    </div>                              
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="gst" class="form-control" value="{{$proforma_invoice->gst}}">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="prepaid_coll" class="default-select form-control wide me-2">
                                                    <option value="">select</option>
                                                    <option value="C" {{$proforma_invoice->prepaid_coll == 'C'? 'selected' : ''}}>C</option>
                                                    <option value="P" {{$proforma_invoice->prepaid_coll == 'P'? 'selected' : ''}}>P</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="gst_applicable" class="default-select form-control wide me-2">
                                                    <option value="">select</option>
                                                    <option value="Y" {{$proforma_invoice->gst_applicable == 'Y'? 'selected' : ''}}>Y</option>
                                                    <option value="N" {{$proforma_invoice->gst_applicable == 'N'? 'selected' : ''}}>N</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="rate_per_unit" class="form-control" value="{{$proforma_invoice->rate_per_unit}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="amount" class="form-control" value="{{$proforma_invoice->amount}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="caf_percent" class="form-control" value="{{$proforma_invoice->caf_percent}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="baf_percent" class="form-control" value="{{$proforma_invoice->baf_percent}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="cc_percent" class="form-control" value="{{$proforma_invoice->cc_percent}}">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="cc_apply" class="default-select form-control wide me-2">
                                                    <option value="">select</option>
                                                    <option value="N" {{$proforma_invoice->cc_apply == 'N'? 'selected' : ''}}>N</option>
                                                    <option value="Y" {{$proforma_invoice->cc_apply == 'Y'? 'selected' : ''}}>Y</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="gstin" class="form-control" value="{{$proforma_invoice->gstin}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="cgst" class="form-control" value="{{$proforma_invoice->cgst}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="igst" class="form-control" value="{{$proforma_invoice->igst}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="caf_amount" class="form-control" value="{{$proforma_invoice->caf_amount}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="baf_amount" class="form-control" value="{{$proforma_invoice->baf_amount}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="cc_amount" class="form-control" value="{{$proforma_invoice->cc_amount}}">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="caf_apply" class="default-select form-control wide me-2">
                                                    <option value="">select</option>
                                                    <option value="N" {{$proforma_invoice->caf_apply == 'N'? 'selected' : ''}}>N</option>
                                                    <option value="Y" {{$proforma_invoice->caf_apply == 'Y'? 'selected' : ''}}>Y</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="sac_code" class="form-control" value="{{$proforma_invoice->sac_code}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="sgst" class="form-control" value="{{$proforma_invoice->sgst}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="total" class="form-control" value="{{$proforma_invoice->total}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
