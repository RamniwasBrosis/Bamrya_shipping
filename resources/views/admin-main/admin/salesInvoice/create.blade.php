            ...
            <div class="col-xl-12 col-xxl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="smartwizard" class="form-wizard order-create">
                            <div class="row form-material">
                                ...
                                <div class="form-validation">
                                    <form method="POST" action="{{route('sales-invoices.store')}}" class="needs-validation">
                                        @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <select name="invoice_type" class="form-control">
                                                    <option value="">Select</option>
                                                    <option value="1">DEBITNOTE(Rs)</option>
                                                    <option value="2">CREDITNOTE(Rs)</option>
                                                    <option value="3">DEBITNOTE(Ovr.)</option>
                                                    <option value="4">CREDITNOTE(Ovr.)</option>
                                                    <option value="5">COMMISSION/REBATE</option>
                                                    <option value="6">SEZ</option>
                                                    <option value="7">FRT(IGST)</option>
                                                    <option value="8">FRT(CreditNote)</option>
                                                </select>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <label class="form-label">Full Inv No:</label>
                                                <input type="text" name="full_invoice_no" class="form-control">
                                            </div>
                                            <div class="col-md-4 mb-3">
                        ...
                        <hr>
                        <div class="form-validation">
                            <form class="needs-validation" method="POST" action="{{ route('sales-invoices.salesInvoiceCharge') }}">
                                @csrf
                                <input type="hidden" name="salesInvoice_id" value="{{session('id')}}">
                                <div class="row">
                                    <!-- Charge Name -->
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
