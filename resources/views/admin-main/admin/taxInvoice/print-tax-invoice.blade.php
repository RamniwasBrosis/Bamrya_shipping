...
<body>
    ...
    <table class="info-table" style="margin-bottom:6px;">
        ...
        <tr>
            <td class="info-left"><strong>SBill NO/DATE:</strong> {{ $porformaInvoice->shipping_no ?? '' }}</td>
            <td class="info-mid"><strong>PORT OF DELIVERY:</strong></td>
            <td class="info-right">{{ $porformaInvoice->pod ?? '' }}</td>
        </tr>
        <tr>
            <td class="info-left"><strong>BOE DATE:</strong> {{ $porformaInvoice->boe_date ?? '' }}</td>
            <td class="info-mid"><strong>GROSS WEIGHT:</strong></td>
            <td class="info-right">{{ $porformaInvoice->gross_weight ?? 0 }}</td>
        </tr>
        <tr>
            <td class="info-left"><strong>CBM:</strong> {{ $porformaInvoice->cbm ?? '' }}</td>
            <td class="info-mid"><strong>CHARGEABLE WEIGHT:</strong></td>
            <td class="info-right">{{ $porformaInvoice->chargeable_weight ?? 0 }}</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="info-left"><strong>AWB/BL NO: </strong> {{ $porformaInvoice->awb_bl_no ?? '' }}</td>
    ...
    <table style="width:100%; margin-top:8px;">
        <tr>
            <td style="width:70%;" class="bank-details">
                ...
                Ref: <span>{{$currentDate}}</span> by {{ $porformaInvoice->user->name ?? '' }}
            </td>
            <td style="width:30%; text-align:center; vertical-align: bottom; border: 1px solid #000;">
                <strong>{{ $company->company_name }}</strong><br><br><br><br><br><br>
