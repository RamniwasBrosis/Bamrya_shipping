...
return new class extends Migration
{
    ...
    {
        Schema::create('operation_sea_import_data_entry_conts', function (Blueprint $table) {
            $table->id();

            $table->integer('company_id');            
            $table->string('uuid');

            $table->unsignedBigInteger('sea_imp_ent_id')->nullable();
            $table->foreign('sea_imp_ent_id')->references('id')->on('operation_sea_import_data_entries')->onDelete('set null');
    ...
    {
        Schema::dropIfExists('operation_sea_import_data_entry_conts');
    }
};
