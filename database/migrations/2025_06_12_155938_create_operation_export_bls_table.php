...
return new class extends Migration
{
    ...
    {
        Schema::create('operation_export_bls', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('forwarder_id')->references('id')->on('master_import_parties')->onDelete('set null');
            ...
            $table->text('sbill_date')->nullable();
    ...
    {
        Schema::dropIfExists('operation_export_bls');
    }
};
