...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('operation_sea_imports', function (Blueprint $table) {
            ...
            $table->string('prefix')->default('SI')->nullable();
            ...
            $table->dropForeign(['sales_person_id']); // drop wrong FK
            $table->foreign('sales_person_id')
                  ->references('id')
                  ->on('operation_sales_people')
                  ->onDelete('set null');
            ...
            $table->foreign('forwarder_id')->references('id')->on('master_forwarders')->onDelete('set null');
