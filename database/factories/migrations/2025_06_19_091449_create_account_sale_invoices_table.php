...
return new class extends Migration
{
    ...
    {
        Schema::create('account_sale_invoices', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('overseas_exchange_rate', 10, 2)->nullable();
            $table->enum('gst_type', ['local', 'otherState']);
    ...
    {
        Schema::dropIfExists('account_sale_invoices');
    }
};
