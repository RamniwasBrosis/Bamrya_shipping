...
return new class extends Migration
{
    ...
    {
        Schema::create('account_sales_invoice_container', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('charge_full_invoice_no')->nullable();
            ...
            $table->foreign('sales_invoice_id')->references('id')->on('account_sale_invoices')->onDelete('set null');
    ...
    {
        Schema::dropIfExists('account_sales_invoice_container');
    }
};
