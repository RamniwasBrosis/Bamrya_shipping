...
return new class extends Migration
{
    ...
    {
        Schema::create('account_proforma_invoices_container', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('proforma_invoice_id')->references('id')->on('account_proforma_invoices')->onDelete('set null');
    ...
    {
        Schema::dropIfExists('account_proforma_invoices_container');
    }
};
