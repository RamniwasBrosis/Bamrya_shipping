...
return new class extends Migration
{
    ...
    {
        Schema::create('master_export_parties', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('tally_ledger',70)->nullable();
            ...
            $table->integer('tds_percent')->nullable(); 
    ...
    {
        Schema::dropIfExists('master_export_parties');
    }
};
