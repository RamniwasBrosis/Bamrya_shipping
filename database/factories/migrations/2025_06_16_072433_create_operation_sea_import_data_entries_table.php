...
return new class extends Migration
{
    ...
    {
        Schema::create('operation_sea_import_data_entries', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('port_delivery_id')->nullable();
            $table->foreign('port_delivery_id')->references('id')->on('master_ports')->onDelete('set null');
    ...
    {
        Schema::dropIfExists('operation_sea_import_data_entries');
    }
};
