...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('operation_sea_exports', function (Blueprint $table) {
            ...
            $table->string('prefix')->default('SE')->nullable();
            ...
            $table->date('port_cutoff')->nullable();
            $table->date('si_cutoff')->nullable();
            $table->date('document_cutoff')->nullable();
            $table->date('vgm_cutoff')->nullable();
