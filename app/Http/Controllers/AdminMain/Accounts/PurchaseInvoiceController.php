...
class PurchaseInvoiceController extends Controller
{
    ...
    {
        $query = AccountPurchaseInvoice::where('company_id', $this->company_id);
        ...
        return view('admin-main.admin.purchaseInvoice.index', compact('purchase_invoices', 'job_nums'));
    }
    ...
    public function create()
    {
        ...
        return view('admin-main.admin.purchaseInvoice.create', compact('parties', 'charges', 'files'));
    }
    ...
    public function edit(string $uuid)
    {
        ...
        $purchase_invoice = AccountPurchaseInvoice::where('uuid', $uuid)->firstOrFail();

        return view('admin-main.admin.purchaseInvoice.edit', compact('parties', 'charges', 'purchase_invoice'));
    }
    ...
    public function purchaseInvoiceCharge(Request $request){
        if(!$request->filled('purchaseInvoice_id')){
            return redirect()->back()->with('error', 'Please filled before above sales invoice form. ');
        }

        $add_charges = AccountPurchaseInvoice::findOrFail($request->purchaseInvoice_id);
    ...
    public function UpdatePurchaseInvoiceCharge(Request $request, $id){
        ...
        $add_charges = AccountPurchaseInvoice::findOrFail($id);
