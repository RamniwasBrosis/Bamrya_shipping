...
class PurchaseLedgerController extends Controller
{
    ...
    public function index(){
        ...
        return view('admin-main.admin.purchaseLedger.first', compact('parties'));
    }
                    ...
                    <div>
                        <div class="dropdown mb-3">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="'.route('purchase-ledger.download', ['format' => 'pdf']).'" target="_blank">Download PDF</a></li>
                                <li><a class="dropdown-item" href="'.route('purchase-ledger.download', ['format' => 'excel']) .'" target="_blank">Download Excel</a></li>
                                <li><a class="dropdown-item" href="'.route('purchase-ledger.download', ['format' => 'word']) .'" target="_blank">Download Word</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
